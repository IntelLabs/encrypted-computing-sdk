...
class MemoryModel:
    ...
    __XINST_QUEUE_MAX_CAPACITY: int # = 1 * Constants.MEGABYTE
    __CINST_QUEUE_MAX_CAPACITY: int # = 128 * Constants.KILOBYTE
    __MINST_QUEUE_MAX_CAPACITY: int # = 128 * Constants.KILOBYTE
    __STORE_BUFFER_MAX_CAPACITY: int # = 128 * Constants.KILOBYTE

    # Class-level attributes
    __NUM_BLOCKS_PER_TWID_META_WORD: int # = 4
    __NUM_BLOCKS_PER_KGSEED_META_WORD: int # = 4
    __NUM_ROUTING_TABLE_REGISTERS: int # = 1
    __NUM_ONES_META_REGISTERS: int # = 1
    __NUM_TWIDDLE_META_REGISTERS: int # = 32 * __NUM_ONES_META_REGISTERS
    __TWIDDLE_META_REGISTER_SIZE_BYTES: int # = 8 * Constants.KILOBYTE
    __MAX_RESIDUALS: int # = __NUM_TWIDDLE_META_REGISTERS * 2
    __NUM_REGISTER_BANKS: int # = 4
    __NUM_REGISTERS_PER_BANK: int # = 72
