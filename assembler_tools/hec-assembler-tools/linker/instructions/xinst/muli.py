...
"""@brief This module implements the muli X-instruction which performs element-wise polynomial scaling by an immediate value."""
...
class Instruction(XInstruction):
    """
    @brief Encapsulates a `muli` XInstruction.
    ...
    def _get_name(cls) -> str:
        ...
        @return The name of the instruction, which is "muli".
        """
        return "muli"

    def __init__(self, tokens: list, comment: str = ""):
        """
        @brief Constructs a new `muli` XInstruction.
