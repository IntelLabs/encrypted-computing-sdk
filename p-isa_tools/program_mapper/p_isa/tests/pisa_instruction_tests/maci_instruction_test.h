...
class maciInstructionTest : public PisaInstructionTest
{
public:
    static std::string operationName() { return "maci_instruction"; }
...
public:
    void constructTest() override
    {
        ...
        auto instr = new pisa::instruction::Maci(std::stoi(configuration["Poly_mod_log2"]),
