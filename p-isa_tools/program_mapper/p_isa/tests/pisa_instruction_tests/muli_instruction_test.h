...
class muliInstructionTest : public PisaInstructionTest
{
public:
    static std::string operationName() { return "muli_instruction"; }
...
public:
    void constructTest() override
    {
        ...
        auto instr = new pisa::instruction::Muli(std::stoi(configuration["Poly_mod_log2"]),
