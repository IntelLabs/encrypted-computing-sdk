...
class mulInstructionTest : public PisaInstructionTest
{
public:
    static std::string operationName() { return "mul_instruction"; }
...
public:
    void constructTest() override
    {
        ...
        auto instr = new pisa::instruction::Mul(std::stoi(configuration["Poly_mod_log2"]),
