...
class addInstructionTest : public PisaInstructionTest
{
public:
    static std::string operationName() { return "add_instruction"; }
...
public:
    void constructTest() override
    {
        ...
        auto add_instr = new pisa::instruction::Add(std::stoi(configuration["Poly_mod_log2"]),
        ...
        instruction_trace.push_back(add_instr);
